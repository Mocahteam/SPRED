...
local function Start ()
	...
	-- create my unit
	myUnits[1].id = Spring.CreateUnit("bit", 1400, Spring.GetGroundHeight(1400, 1371), 1371, "s", 0)
	myUnits[2].id = Spring.CreateUnit("bit", 1461, Spring.GetGroundHeight(1461, 1453), 1453, "s", 0)
	myUnits[3].id = Spring.CreateUnit("bit", 1379, Spring.GetGroundHeight(1379, 1444), 1444, "s", 0)
	myUnits[4].id = Spring.CreateUnit("bit", 1438, Spring.GetGroundHeight(1438, 1313), 1313, "s", 0)
	myUnits[5].id = Spring.CreateUnit("bit", 1328, Spring.GetGroundHeight(1328, 1381), 1381, "s", 0)
	myUnits[6].id = Spring.CreateUnit("bit", 1311, Spring.GetGroundHeight(1311, 1311), 1311, "s", 0)
	myUnits[7].id = Spring.CreateUnit("bit", 1408, Spring.GetGroundHeight(1408, 1266), 1266, "s", 0)
	myUnits[8].id = Spring.CreateUnit("byte", 479, Spring.GetGroundHeight(479, 1825), 1825, "s", 0)
	myUnits[9].id = Spring.CreateUnit("byte", 449, Spring.GetGroundHeight(449, 1758), 1758, "s", 0)
	myUnits[10].id = Spring.CreateUnit("byte", 507, Spring.GetGroundHeight(507, 1894), 1894, "s", 0)	

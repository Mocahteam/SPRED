...
function WriteScript(GtW,ScriptFileName)
	...
	WriteNumFieldAndComment("nowalls",GtW.ModOptions.nowalls,"Because neither AI can't handle them")
	WriteNumFieldAndComment("nospecials",GtW.ModOptions.nospecials,"Set to make it simpler")
	WriteNumFieldAndComment("ons",GtW.ModOptions.ons,"Shielded gamemode, 0 for disabled, 2 for weak, 4 for ultra")
	WriteNumFieldAndComment("sos",GtW.ModOptions.sos,"Amount per building, 0 for disabled")
	WriteNumFieldAndComment("colorwars",GtW.ModOptions.colorwars,"Time in minutes before doom, 0 for disabled")
	if GtW.ModOptions.preplaced then
		WriteNumFieldAndComment("preplaced",GtW.ModOptions.preplaced,"Give a pre-built base")
	end

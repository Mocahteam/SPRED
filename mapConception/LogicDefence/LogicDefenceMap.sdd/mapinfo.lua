...
local mapinfo = {
	name        = "LogicDefenceMap",
	shortname   = "LogicDefenceMap",
	description = "Map for MPLog",
	author      = "mmuratet",
	version     = "v1",
	--mutator   = "deployment";
	...
	resources = {
		grassBladeTex = "grass.png",

		--grassShadingTex = "",
		detailTex = "SimpleMapCircuitry.png",
		--specularTex = "",
		--splatDetailTex = "",
		--splatDistrTex = "",
		--skyReflectModTex = "",
	...
	teams = {
		[0] = {startPos = {x = 400, z = 400}},
		[1] = {startPos = {x = 400, z = 400}},
		[2] = {startPos = {x = 400, z = 1600}},
		[3] = {startPos = {x = 400, z = 1600}},
	},

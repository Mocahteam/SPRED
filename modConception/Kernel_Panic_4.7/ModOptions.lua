...
local options=
{
	...
	},
	{
		...
		desc="The one with a unit closest to center for that many minutes win.",
		type="number",
		min = 0,
		max = 10080,
		step = 1,
	...
	{
		section='kpopt',
		key="ModifyStatistics0",
		name="Rebalancing formula",
		desc="\n\nSimple syntax exemple (double the byte health and firerate):\n  Byte maxdamage *2 MegaBeam reloadtime x0.5\n\nComplex syntax exemple (all in one line):\n  unit bit bug packet maxvelocity +0 turnrate -0 acceleration x1.0 brakerate /1.0\n  CanMove 1 name Modified-Spam weapon line bugshot packetbeam damage +50 x3\n\n Alias exemple:\n  hero weapon range x.8 heavy maxvelocity x2 weapon spam arty areaofeffect  *2\n\nRead infolog.txt for results, errors and help.\nType help here to print all the lists in infolog.",
		type="string",
		def = "",
	},
...
-- HOMF modotoptions made redundant by the ModifyStatistics0 modoption, commenting them out
--[[
	{
		section='homf_sec',
		key="homf_speed",

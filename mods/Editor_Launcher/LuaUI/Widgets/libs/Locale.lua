...
function GetLauncherStrings(lang)
	if lang == "fr" then
		...
		LAUNCHER_ERROR1 = "L'éditeur ne fonctione pas sur la version de Spring que vous utilisez."
		LAUNCHER_ERROR2 = "Merci d'utiliser la version 0.82.5.1 pour Prog&Play ou une version 98+."
	else
		...
		LAUNCHER_QUIT = "Quit"
		LAUNCHER_ERROR1 = "The editor does not work on the version of Spring you are using."
		LAUNCHER_ERROR2 = "Please use the tweaked 0.82.5.1 or a 98+ version."
	end
end
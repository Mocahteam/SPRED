...
function GetLauncherStrings(lang)
	if lang == "fr" then
		...
		LAUNCHER_SCENARIO_EXPORT_GAME_SUCCESS = "Le jeu /GAMENAME/ a bien été exporté."
		LAUNCHER_SCENARIO_EXPORT_GAME_FAIL = "Le jeu /GAMENAME/ existe déjà."
		...
		LAUNCHER_SCENARIO_EXPORT_GAME_SUCCESS = "The game /GAMENAME/ has been successfully exported."
		LAUNCHER_SCENARIO_EXPORT_GAME_FAIL = "The game /GAMENAME/ already exists."

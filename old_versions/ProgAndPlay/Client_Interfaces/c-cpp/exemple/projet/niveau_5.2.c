...
/* une cible. Celle-ci est déterminée en observant les cibles effectives des */
/* membres du groupe. Si elles ne sont pas identiques, une d'entre elles est */
/* choisie pour recentrer l'attaque. Si les membres du groupe n'ont pas de   */
/* cible, l'unité adverse la plus proche est affectée à ce groupe.           */
/*****************************************************************************/

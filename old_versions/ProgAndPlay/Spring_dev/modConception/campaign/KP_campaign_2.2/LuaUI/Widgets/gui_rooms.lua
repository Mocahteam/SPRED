...
function Window:UpdateDisplayList()
  Spring.Echo ("UpdateDisplayList d'une fenêtre")
  ...
  Spring.Echo ("UpdateDisplayList du fils...")
...
function Window:Open() -- FIXME: ignore if already opened
  Spring.Echo ("Open d'une fenêtre")
...
function Window:Close()
  Spring.Echo ("Fermeture d'une fenêtre")
  ...
  if self.son ~= nil then
    if not self.son.closed then
		Spring.Echo("Appel de la fermeture du fils")
		self.son:Close()
	end
  end
  --

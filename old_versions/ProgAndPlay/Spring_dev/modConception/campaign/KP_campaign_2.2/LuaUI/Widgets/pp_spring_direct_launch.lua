...
local function MissionsMenu(lang)
	RemoveAllFrames()
	AddFrame("Prog&Play!",{x=vsx*0.5,y=vsy*0.98},vsy/14,{0,1,1,0.5},"ct","c")
	local MissionsList=JoinArrays(VFS.DirList("Missions/"..Game.modShortName.."/"..lang),VFS.DirList("Missions"))
	...
	if lang == "fr" then
		AddFrame("Retour",{x=vsx*0.5,y=0},ItemSize*0.8,{0,0,1,0.5},"cb","c",FunctionsList.MainMenu)
	else
...
local function MainMenu()
	...
	AddFrame("Quit",{x=vsx*0.5,y=vsy*0.0},vsy/18,{0,1,0,0.5},"cb","c",FunctionsList.Quit)
end
...
function widget:Initialize()
	...
	FunctionsList={MainMenu=MainMenu,Quit=Quit,
		MissionsMenu=MissionsMenu,French=French,English=English,SwitchOn=SwitchOn,SwitchOff=SwitchOff,SwitchOffNoEndGraph=SwitchOffNoEndGraph}
	FramesList={}
	FillModSpecific()

...
"campaign.lua" ordinates missions in campaign. You must edit it and indicate which mission is the first (MissionXXX.lua and associated launcher MissionXXX.txt), which mission is the second (MissionXXX.lua and associated launcher MissionXXX.txt), ...

...
slides[1] = {
    ...
    {text = "Mathieu Muratet", relY = 0.5, font = "LuaUI/Fonts/FreeSansBold_30", align = "center"},
	{text = "IUT du Puy-en-Velay - 8 novembre 2013", relY = 0.25, align = "center"}
}
slides[2] = {
	{text = "", autosize = false, showBox = true, align = "center"},
...
slides[3] = {
	{text = "", autosize = false, showBox = true, align = "center"},
    {text = "Application de Prog&Play ?", relY = 0.8, font = "LuaUI/Fonts/FreeSansBold_30", align = "center"},
...
function addFooter()
	for i, slide in pairs(slides) do
		if i > 1 then
			...
			table.insert(slide, {text = "IUT du Puy-en-Velay - 8 novembre 2013", relY = 0.05, showBox = false, font = "LuaUI/Fonts/FreeSansBold_16", align = "center"})

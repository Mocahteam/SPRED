...
function widget:GameFrame( frameNumber )
	if frameNumber%4 == 0 then
		...
		if state.mode == 1 then
			...
			-- add specific area around hidden enemy (1648, 1024) for level 2
			if Spring.GetModOptions()["level"] == "2" then
				if 1548 < xMin then xMin = 1548 end
				if 1748 > xMax then xMax = 1748 end
				if 924 < zMin then zMin = 924 end
				if 1124 > zMax then zMax = 1124 end
			end

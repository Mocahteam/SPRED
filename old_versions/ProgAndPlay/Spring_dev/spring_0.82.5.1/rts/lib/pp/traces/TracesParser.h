...
public:
	...
	/**
	  ...
	  *
	  * Cette fonction appelle la fonction ParamsMap::initMap afin de charger les paramètres de compression.
	  *
	  * \param json la chaîne de caractères contenant les paramètres de compression au format JSON.
	  *
	  * \see ParamsMap
	  */
